...
urlpatterns = [
    ...
    path('bulk_create/', views.bulk_create, name='singer-bulk_create'),
    path('update/<int:singer_id>/', views.update, name='singer-update'),
    path('delete/<int:singer_id>/', views.delete, name='singer-delete'),
    path(
        'detail/<int:singer_id>/songs/',
        views.get_list_songs,
        name='singer-list_songs'),
    path(
        'detail/<int:singer_id>/albums/',
        views.get_list_albums,
        name='singer-list_albums'),
